...
OUTPUT_PATH = os.path.join(
    ...
    "data",
    "features",
    "smart_overbooking_recommendations.csv"
)
...
bookings["NoShow_Probability"] = model.predict_proba(
    bookings[feature_cols]
)[:, 1]
...
bookings["Smart_Deferral_Score"] = (
    0.6 * bookings["NoShow_Probability"]
    + 0.4 * bookings["Deferral_Candidate_Score"]
)
...
movable_bookings = bookings[
    bookings["Booking Status"].isin(movable_statuses)
].copy()
...
for _, voyage in overbooked_voyages.iterrows():
    ...
    for _, booking in voyage_bookings.iterrows():
        ...
        recommendations.append({
            ...
            "NoShow_Probability": booking["NoShow_Probability"],
            "Smart_Deferral_Score": booking["Smart_Deferral_Score"]
        })
...
print("=" * 70)
print("SMART OVERBOOKING RECOMMENDATION ENGINE")
print("=" * 70)

print("\nTotal overbooked voyages:")
print(len(overbooked_voyages))

print("\nTotal smart recommendation rows:")
print(len(recommendations_df))

print("\nTop 30 smart recommendations:")
print(
    recommendations_df[
        [
            "Departure Port",
